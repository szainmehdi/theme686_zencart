...
<div id="cartSubTotal"><?php echo SUB_TITLE_SUB_TOTAL; ?> <span class="price"><?php echo $cartShowTotal; ?></span></div>
<br class="clearBoth" />
...
<div class="wrapper">
	...
	<?php echo '<div class="btn1"><a href="' . zen_href_link(FILENAME_CHECKOUT_SHIPPING, '', 'SSL') . '">' . zen_image_button(BUTTON_IMAGE_CHECKOUT, BUTTON_CHECKOUT_ALT) . '</a></div>'; ?>
